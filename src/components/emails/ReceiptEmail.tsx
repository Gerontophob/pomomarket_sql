...
export const ReceiptEmail = ({
  ...
  const total =
    products.reduce((acc, curr) => acc + curr.price, 0) + delivery_fee;

  return (
    <Html>
      <Head />
      <Preview>Votre Reçu POMO</Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Column>
              <Img
                src={`${process.env.NEXT_PUBLIC_SERVER_URL}/pomo-email-sent.jpg`}
                width="100"
                height="100"
                alt="POMO"
              />
          ...
          <Section style={informationTable}>
            <Row style={informationTableRow}>
              ...
              <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>ID DE COMMANDE</Text>
                <Link
                  style={{
                    ...informationTableValue,
                  }}
          ...
          <Section style={productTitleTable}>
            <Text style={productsTitle}>Détail de la commande</Text>
          </Section>
          ...
          <Section>
            ...
            >
              <Text style={productTitle}>Frais de livraison</Text>
            </Column>
